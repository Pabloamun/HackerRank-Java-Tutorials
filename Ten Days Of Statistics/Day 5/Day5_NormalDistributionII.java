...
public class Day5_NormalDistributionII {
	...
	public static void main(String[] args) {
		double mean = 70;
		double std = 10;
		System.out.format("%.2f%n", 100 * (1 - cumulative(mean, std, 80)));
		System.out.format("%.2f%n", 100 * (1 - cumulative(mean, std, 60)));
		System.out.format("%.2f%n", 100 * cumulative(mean, std, 60));
	}
